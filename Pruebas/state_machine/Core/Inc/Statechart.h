...
#define SCVI_STATECHART_MAIN_REGION_ENCENDIDO 0
#define SCVI_STATECHART_MAIN_REGION_APAGADO 0
...
typedef enum
{
	...
	Statechart_main_region_Encendido,
	Statechart_main_region_Apagado
} StatechartStates;
...
{
	sc_boolean buttonPushed_raised;
};
...
/*! Raises the in event 'buttonPushed' that is defined in the default interface scope. */ 
extern void statechart_raise_buttonPushed(Statechart* handle);
