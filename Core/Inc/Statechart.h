...
#define SCVI_STATECHART_MAIN_REGION_IDLE 0
#define SCVI_STATECHART_MAIN_REGION_RECORDING 0
...
typedef enum  {
	...
	Statechart_startRecord,
	Statechart_stopRecord
} StatechartEventID;
...
typedef enum
{
	...
	Statechart_main_region_idle,
	Statechart_main_region_recording
} StatechartStates;
...
{
	sc_boolean startRecord_raised;
	sc_boolean stopRecord_raised;
};
...
/*! Raises the in event 'startRecord' that is defined in the default interface scope. */ 
extern void statechart_raise_startRecord(Statechart* handle);
/*! Raises the in event 'stopRecord' that is defined in the default interface scope. */ 
extern void statechart_raise_stopRecord(Statechart* handle);
